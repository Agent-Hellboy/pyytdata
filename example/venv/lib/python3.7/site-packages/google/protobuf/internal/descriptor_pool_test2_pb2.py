...
from google.protobuf.internal import (
    more_messages_pb2 as google_dot_protobuf_dot_internal_dot_more__messages__pb2,
)
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        google_dot_protobuf_dot_internal_dot_descriptor__pool__test1__pb2.DESCRIPTOR,
...
_DESCRIPTORPOOLTEST3_NESTEDMESSAGE_DEEPNESTEDMESSAGE_NESTEDENUM = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="RHO", index=0, number=17, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="SIGMA", index=1, number=18, serialized_options=None, type=None
        ),
    ],
...
_DESCRIPTORPOOLTEST3_NESTEDMESSAGE_NESTEDENUM = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="OMICRON", index=0, number=15, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="PI", index=1, number=16, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
...
_DESCRIPTORPOOLTEST3_NESTEDENUM = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="NU", index=0, number=13, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="XI", index=1, number=14, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
...
_DESCRIPTORPOOLTEST3_NESTEDMESSAGE_DEEPNESTEDMESSAGE = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_DESCRIPTORPOOLTEST3_NESTEDMESSAGE_DEEPNESTEDMESSAGE_NESTEDENUM,],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
_DESCRIPTORPOOLTEST3_NESTEDMESSAGE = _descriptor.Descriptor(
    ...
    enum_types=[_DESCRIPTORPOOLTEST3_NESTEDMESSAGE_NESTEDENUM,],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
_DESCRIPTORPOOLTEST3 = _descriptor.Descriptor(
    ...
    enum_types=[_DESCRIPTORPOOLTEST3_NESTEDENUM,],
    serialized_options=None,
    is_extendable=False,
    syntax="proto2",
    extension_ranges=[],
...
_DESCRIPTORPOOLTEST3_NESTEDMESSAGE_DEEPNESTEDMESSAGE.fields_by_name[
    "nested_enum"
].enum_type = _DESCRIPTORPOOLTEST3_NESTEDMESSAGE_DEEPNESTEDMESSAGE_NESTEDENUM
_DESCRIPTORPOOLTEST3_NESTEDMESSAGE_DEEPNESTEDMESSAGE.containing_type = (
    _DESCRIPTORPOOLTEST3_NESTEDMESSAGE
)
_DESCRIPTORPOOLTEST3_NESTEDMESSAGE_DEEPNESTEDMESSAGE_NESTEDENUM.containing_type = (
    _DESCRIPTORPOOLTEST3_NESTEDMESSAGE_DEEPNESTEDMESSAGE
)
_DESCRIPTORPOOLTEST3_NESTEDMESSAGE.fields_by_name[
    "nested_enum"
].enum_type = _DESCRIPTORPOOLTEST3_NESTEDMESSAGE_NESTEDENUM
_DESCRIPTORPOOLTEST3_NESTEDMESSAGE.fields_by_name[
    "deep_nested_message"
].message_type = _DESCRIPTORPOOLTEST3_NESTEDMESSAGE_DEEPNESTEDMESSAGE
_DESCRIPTORPOOLTEST3_NESTEDMESSAGE.containing_type = _DESCRIPTORPOOLTEST3
_DESCRIPTORPOOLTEST3_NESTEDMESSAGE_NESTEDENUM.containing_type = (
    _DESCRIPTORPOOLTEST3_NESTEDMESSAGE
)
_DESCRIPTORPOOLTEST3.fields_by_name[
    "nested_enum"
].enum_type = _DESCRIPTORPOOLTEST3_NESTEDENUM
_DESCRIPTORPOOLTEST3.fields_by_name[
    "nested_message"
].message_type = _DESCRIPTORPOOLTEST3_NESTEDMESSAGE
...
_DESCRIPTORPOOLTEST3.extensions_by_name[
    "descriptor_pool_test"
].message_type = _DESCRIPTORPOOLTEST3
