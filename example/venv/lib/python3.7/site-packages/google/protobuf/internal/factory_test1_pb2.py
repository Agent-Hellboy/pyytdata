...
_FACTORY1MESSAGE = _descriptor.Descriptor(
    ...
    enum_types=[_FACTORY1MESSAGE_NESTEDFACTORY1ENUM,],
    serialized_options=None,
    is_extendable=True,
    syntax="proto2",
...
].enum_type = _FACTORY1MESSAGE_NESTEDFACTORY1ENUM
_FACTORY1MESSAGE.fields_by_name[
    "nested_factory_1_message"
].message_type = _FACTORY1MESSAGE_NESTEDFACTORY1MESSAGE
...
Factory1MethodRequest = _reflection.GeneratedProtocolMessageType(
...
Factory1MethodResponse = _reflection.GeneratedProtocolMessageType(
