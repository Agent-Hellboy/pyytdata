...
from google.protobuf import (
    unittest_import_public_pb2 as google_dot_protobuf_dot_unittest__import__public__pb2,
)
...
_IMPORTENUM = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="IMPORT_FOO", index=0, number=7, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="IMPORT_BAR", index=1, number=8, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="IMPORT_BAZ", index=2, number=9, serialized_options=None, type=None
        ),
    ],
...
ImportMessage = _reflection.GeneratedProtocolMessageType(
    "ImportMessage",
    (_message.Message,),
    {
