...
_SYNTAX = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="SYNTAX_PROTO2", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="SYNTAX_PROTO3", index=1, number=1, serialized_options=None, type=None
        ),
    ],
...
_FIELD_KIND = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="TYPE_DOUBLE", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TYPE_FLOAT", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TYPE_INT64", index=3, number=3, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TYPE_UINT64", index=4, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TYPE_INT32", index=5, number=5, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TYPE_FIXED64", index=6, number=6, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TYPE_FIXED32", index=7, number=7, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TYPE_BOOL", index=8, number=8, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TYPE_STRING", index=9, number=9, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TYPE_GROUP", index=10, number=10, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TYPE_MESSAGE", index=11, number=11, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TYPE_BYTES", index=12, number=12, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TYPE_UINT32", index=13, number=13, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TYPE_ENUM", index=14, number=14, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TYPE_SFIXED32",
            index=15,
        ...
        _descriptor.EnumValueDescriptor(
            name="TYPE_SINT32", index=17, number=17, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TYPE_SINT64", index=18, number=18, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
...
_FIELD = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[],
    enum_types=[_FIELD_KIND, _FIELD_CARDINALITY,],
    serialized_options=None,
    is_extendable=False,
    syntax="proto3",
    extension_ranges=[],
